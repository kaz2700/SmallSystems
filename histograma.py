...
datos = []
with open('data/modulos_final.dat', 'r') as f:
    for line in f:
...
with open('data/histograma.dat', 'w') as f:
    for i in range(nbins):
...
print(f"N={n} particulas, bins={nbins}")
print(f"Media: {sum(datos)/n:.4f}")
print(f"Teorico media: {math.sqrt(8*T/math.pi):.4f}")
